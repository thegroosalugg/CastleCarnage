...
def random_enemy
  enemies = [
    ...
    { name: "🧛‍♂️ Vampire", hp: rand(400..500), attack: (12..18).to_a, block: (3..8).to_a, crit_ch: (1..10).to_a, crit_x: -> { rand(1.2..2.0) }  },
    { name: "🐺 Zombie", hp: rand(400..500), attack: (12..18).to_a, block: (3..8).to_a, crit_ch: (1..10).to_a, crit_x: -> { rand(1.2..2.0) }  },
