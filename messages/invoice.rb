...
def invoice(who, what, why)
  ...
  # elsif item[:stat] == :aim || item[:stat] == :chance                       # correct tag is applied to attack/block
  #   BUFFS[item[:stat]]                         # aim is a nerf and crit ch is buff so the respective keys are applied
